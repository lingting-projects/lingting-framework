 ...
 */
public class ForwardingClientOnCall<S, R> extends ForwardingClientCall.SimpleForwardingClientCall<S, R> {

	protected ForwardingClientOnCall(ClientCall<S, R> delegate) {
		super(delegate);
	}
