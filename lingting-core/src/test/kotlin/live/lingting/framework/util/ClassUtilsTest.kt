...
class ClassUtilsTest {
    ...
    fun test() {
        ...
        val typesN = ClassUtils.typeArguments(N::class.java)
        assertTrue(typesN.isEmpty())
        val typesS1 = ClassUtils.typeArguments(S1::class.java)
        assertEquals(1, typesS1.size)
        assertEquals(N::class.java, typesS1[0])
        val typesI1 = ClassUtils.typeArguments(I1::class.java)
        assertEquals(1, typesI1.size)
        assertEquals(N::class.java, typesI1[0])
        val typesSI = ClassUtils.typeArguments(SI::class.java)
